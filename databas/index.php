...
<body>
    ...
    <?php $idea_text = $_POST['texte']; ?>
    <?php endif; ?>

    <?php $new_idea = array('title'=>$idea_title,'texte' =>$idea_text); ?>
    ...
    <form action="" method="POST">
        ...
        <textarea name="texte" rows="8" cols="80"><?php if(isset($_POST['text'])){echo $_POST['text'];} ?></textarea>
        <br><br>
    ...
    <?php $results = $statement->fetchAll() // ijlib jami3 nata2ij dyl tbi9 execute ?>
